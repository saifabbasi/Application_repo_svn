 ...
 * @version 0.1.2
 */
class CPAStaxx Extends LinkTrustAbstract {
	/**
	 * @access protected
	 * @var string $apiUrl
	 */
	 ...
	 */
	protected $offersUrl = 'http://publishers.cpastaxx.com/RequestOffers.aspx';
	
	/**
	 * @access protected
	 * @var string $loginUrl
	 */
	protected $loginUrl = 'http://publishers.cpastaxx.com/Welcome/LogInAndSignUp.aspx';
	
	/**
	 * @access protected
	 * @var string $offersUsername
	 */
	protected $offersUsername = '153833';
	
	/**
	 * @access protected
	 * @var string $offersPassword
	 */
	protected $offersPassword = 'Welcome01';
	 ...
	 * @var string $csvUrl
	 */
	protected $csvUrl = 'http://publishers.cpastaxx.com/RptSubIdBreakout.aspx';
