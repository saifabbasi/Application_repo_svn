...
<div class="successInstall">
		...
		<br/> Please allow up to 24 hours for your account to
					...
					<br />You are now able to write campaigns immediately. To upload your stats to your account, please <a href="/BevoMedia/Publisher/YahooManualUpload.html?ID=<?=$this->newId?>" onclick="parent.window.location = this.href; return false;" target="_parent">click here</a>
...
<table class='shadowbox-table <?php print ($this->editEmail)?('displayNone'):(''); ?>'>
	...
	<tr>
		...
		<a class="tooltip" title="You can find your
                    MasterAccountID by Logging into your Yahoo account and going to the 'Administration' tab and selecting 'Master Account'.">
			<img src="/Themes/BevoMedia/img/questionMarkIcon.png" width="12" height="12" />
		</a>
		</td>
	</tr>
