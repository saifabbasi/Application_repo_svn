...
<div class="successInstall">
		...
		<br/> Please allow up to 24 hours for your account to
					be fully loaded on the Bevo interface<br />
		You are now able to write campaigns immediately. To upload your stats to your account, please <a href="/BevoMedia/Publisher/MSNManualUpload.html?ID=<?=$this->newId?><?=$this->isApiStr?>" onclick="return ParentToBevoLive(this)"" target="_parent">click here</a>
