...
abstract class PaymentGateway
{
    ...
    public function submitPayment()
    {
        ...
        $this->prepareSubmit();
        $r .= "<script>$(function() {document.forms['gateway_form'].submit();});</script>\n";
        $r .= "<h3>Please wait</h3>";
        $r .= "<p><strong>Your order is being processed. You will be redirected to the payment website in a few seconds.</strong></p>\n";
        $r .= "<form method=\"POST\" name=\"gateway_form\" ";
        $r .= "action=\"" . $this->gatewayUrl . "\">\n";
        ...
        $r .= "<p>If you are not being redirected within 5 seconds,
        	<input class=\"formsubmit clickheresmall-pbs\" type=\"submit\" value=\"Click Here\" /></p>\n";
        $r .= "</form>\n";
        return $r;
    }
