 ...
 * @version 0.1.2
 */
class FireLead Extends LinkTrustAbstract {
	/**
	 * @access protected
	 * @var string $apiUrl
	 */
	 ...
	 */
	protected $offersUrl = 'https://partners.firelead.com/RequestOffers.aspx';
	
	/**
	 * @access protected
	 * @var string $loginUrl
	 */
	protected $loginUrl = 'https://partners.firelead.com/Welcome/LogInAndSignUp.aspx';
	
	/**
	 * @access protected
	 * @var string $offersUsername
	 */
	protected $offersUsername = '84523';
	 ...
	 * @var string $csvUrl
	 */
	protected $csvUrl = 'http://partners.firelead.com/RptSubIdBreakout.aspx';
