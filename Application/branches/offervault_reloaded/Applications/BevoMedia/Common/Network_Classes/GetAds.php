 ...
 * @version 0.1.2
 */
class GetAds Extends LinkTrustAbstract {
	/**
	 * @access protected
	 * @var string $apiUrl
	 */
	 ...
	 */
	protected $offersUrl = 'http://publisher.getads.com/RequestOffers.aspx';
	
	/**
	 * @access protected
	 * @var string $loginUrl
	 */
	protected $loginUrl = 'http://publisher.getads.com/Welcome/LogInAndSignUp.aspx';
	
	/**
	 * @access protected
	 * @var string $offersUsername
	 */
	protected $offersUsername = '135213';
	 ...
	 */
	protected $publisherLogin = '';
	
	/**
	 * @access protected
	 * @var string $publisherPassword
	 */
	protected $publisherPassword = '';
	 ...
	 * @var string $csvUrl
	 */
	protected $csvUrl = 'http://publisher.getads.com/RptSubIdBreakout.aspx';
