<?
	$soap_module = array('urls','extractor');
...
?>
<form action="" name="ppvextractor" method="post">
   ...
   if (isset($_POST['ppvfind']) && ($_POST['ppvfind'] == '1'))
   {
	   ...
	   foreach($keywords as $key => $value){
		 ...
		 //Keep room for more detection processes.
		  ...
		  $i = 0;
		  $ppv_results = $PPVTools->ppvtool_extractor($keywords, $_POST['searchdepth']);
		  if(is_array($ppv_results)){
