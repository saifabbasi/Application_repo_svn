...
<a style="text-decoration:none !important;" class='tooltip'  title="Installing a network via API will automatically update your stats once a day for the prior day, and give full functionality of the Yahoo account on the Bevo interface. <br/><br/>The manual upload method will require users to upload an XML report from the Yahoo interface, but allows users to populate their account at any time. API installation is highly recommended.">
