 ...
 * @version 0.1.2
 */
class NDemand Extends LinkTrustAbstract {
	/**
	 * @access protected
	 * @var string $apiUrl
	 */
	 ...
	 */
	protected $offersUrl = 'http://affiliate.ndemandaffiliates.com/RequestOffers.aspx';
	
	/**
	 * @access protected
	 * @var string $myOffersUrl
	 */
	protected $myOffersUrl = 'http://affiliate.ndemandaffiliates.com/MyOffers.aspx';
	
	/**
	 * @access protected
	 * @var string $loginUrl
	 */
	protected $loginUrl = 'http://affiliate.ndemandaffiliates.com/Welcome/LogInAndSignUp.aspx';
	
	/**
	 * @access protected
	 * @var string $offersUsername
	 */
	protected $offersUsername = '153138';
	 ...
	 * @var string $csvUrl
	 */
	protected $csvUrl = 'http://affiliate.ndemandaffiliates.com/RptSubIdBreakout.aspx';
