<?php
  class APIlityManager {
    ...
    function APIlityManager(
      ...
      // parse the default authentication.ini file
		...
		$Sql = "SELECT Value FROM settings WHERE Name = 'Google_Adwords_Developer_Token' ";
		$Row = mysql_query($Sql);
		$Row = mysql_fetch_assoc($Row);		
		$Google_Adwords_Developer_Token = $Row['Value'];
		
		$Sql = "SELECT Value FROM settings WHERE Name = 'Google_Adwords_Application_Token' ";
		$Row = mysql_query($Sql);
		$Row = mysql_fetch_assoc($Row);		
		$Google_Adwords_Application_Token = $Row['Value'];
		
		$Sql = "SELECT Value FROM settings WHERE Name = 'Google_Adwords_Client_Email' ";
		$Row = mysql_query($Sql);
		$Row = mysql_fetch_assoc($Row);		
		$Google_Adwords_Client_Email = $Row['Value'];
		
		$Sql = "SELECT Value FROM settings WHERE Name = 'Google_Adwords_Client_Password' ";
		$Row = mysql_query($Sql);
		$Row = mysql_fetch_assoc($Row);		
		$Google_Adwords_Client_Password = $Row['Value'];
		
		$this->developerToken = !USE_SANDBOX?$Google_Adwords_Developer_Token:$Google_Adwords_Client_Email . "++" . CURRENCY_FOR_SANDBOX;
		$this->applicationToken = $Google_Adwords_Application_Token;
		
		$this->email = $Google_Adwords_Client_Email;
	    $this->password = $Google_Adwords_Client_Password;
  ...
  class APIlityUser extends APIlityManager {  
    ...
    function APIlityUser(
      ...
      $clientEmail = SANDBOX_PREFIX_SBA . $clientEmail;
      ...
      // all other fall backs for the other header fields are in the super class
		...
		$Sql = "SELECT value FROM bevomedia_settings WHERE name = 'Google_Adwords_Client_Email' ";
		$Row = mysql_query($Sql);
		$Row = mysql_fetch_assoc($Row);		
		$Google_Adwords_Client_Email = $Row['value'];
		...
		$clientEmail = $Google_Adwords_Client_Email;
