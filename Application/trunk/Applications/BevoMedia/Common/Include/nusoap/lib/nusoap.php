...
/**
*
* nusoapclientw higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $nusoapclientw = new nusoapclientw( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $nusoapclientw->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($nusoapclientw);
*
...
* @access   public
*/
class nusoapclientw extends nusoap_base  {
	...
	* @access   public
	*/
	function nusoapclientw($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
		$this->endpoint = $endpoint;
		$this->proxyhost = $proxyhost;
		$this->proxyport = $proxyport;
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends nusoapclientw {
	'.$evalStr.'
}';
		return $evalStr;
	}
