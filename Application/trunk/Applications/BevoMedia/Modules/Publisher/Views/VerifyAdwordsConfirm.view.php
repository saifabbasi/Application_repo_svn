...
<div class="lpop lpop_pay">
	<div class="lpop_title">
		<h2>Google Adwords API Fee</h2>
		<p>License to use the Google Adwords API on your Bevo Interface.</p>
	</div>
	...
	<div class="lpop_content">
		...
		<div class="lpop_cart">
			<div class="lpop_cartbox">
				<h3>Google Adwords API Fee</h3>
				<h3 class="floatright">$0.35 per 1000 calls</h3>
				<div class="clear"></div>
				<p>License to use the Google Adwords API on your Bevo Interface.</p>
			</div>
			<div class="lpop_cartbox lpop_securicons">
				<a class="btn btn_lpop_paynow" href="/BevoMedia/User/PayAdwords.html">Pay Now</a>
				<div class="clear"></div>
			</div>
			<div class="lpop_cartbox">
				<ul>
					<li>Your card on file will be billed every $50 or end of your verified month, whichever comes first.</li>
					<li> Your card on file will be billed. To change this card, <a id="VerifyLink" href="#">click here</a>.</li>
				</ul>
