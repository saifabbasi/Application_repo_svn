...
<div class="lpop lpop_license<?php echo $lpopWV = $lpopVid ? ' lpop_withvid' : ''; ?>">
	<div class="lpop_title">
		...
		<p>Get full access to Bevo AdWatcher for only $200 /month or $699 /year!</p>
	</div>
	...
	<a class="btn btn_lpop_continuetopay" href="/BevoMedia/Publisher/VerifyAdWatcherConfirm.html?ajax=true">Contine to Payment Page</a>	
