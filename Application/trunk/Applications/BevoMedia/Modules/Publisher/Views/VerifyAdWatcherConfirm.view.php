...
<div class="lpop lpop_pay">
	<div class="lpop_title">
		...
		<p>Get full access to Bevo AdWatcher for only $200 /month or a $699 one-time payment!</p>
	</div>
	...
	<div class="lpop_content">
		...
		<div class="lpop_cart">
			<div class="lpop_cartbox">
				...
				<div class="price">
					<h3 id="payoption_price">$699 one-time</h3>
					<div class="lpop_payoptions lpop_payoptions_ppvspy">
						<p>Select Payment Option:</p>
						<a class="btn j_payoption btn_lpop_payoption_monthone_monthly" href="#" rel="200" title="Click to switch to the monthly payment plan">Monthly Payment Plan</a>
						<a class="btn j_payoption btn_lpop_payoption_monthone_onetime active" href="#" rel="699" title="Click to make a one-time payment">One-Time Payment</a>
					</div>
				</div>			
				<div class="clear"></div>
			</div>
			...
			<div class="lpop_cartbox">
				...
				<div class="lpop_tos">
					...
					<p>1. AGREEMENT</p>
					<p>These Website Terms of Service (the &quot;Agreement&quot;) constitute a legally binding agreement by and between PPV Spy, a software company owned by a third party developer (hereinafter, &quot;PPV Spy&quot;) and you or your company (in either case, &quot;You&quot; or &quot;Your&quot;) concerning Your use of PPV Spy&rsquo;s software, distributed by BeVo Media, having website located at www.bevomedia.com (the &quot;Website&quot;) and the services available through the Website (the &quot;Services&quot;). By using the Website and Services, You represent and warrant that You have read and understood, and agree to be bound by, this Agreement and the privacy policy found on www.bevomedia.com (the &quot;Privacy Policy&quot;), which is incorporated herein by reference and made part of this Agreement.  IF YOU DO NOT UNDERSTAND THIS AGREEMENT, OR DO NOT AGREE TO BE BOUND BY IT OR THE PRIVACY POLICY, YOU MUST IMMEDIATELY LEAVE THE WEBSITE AND CEASE USING THE SERVICES.</p>
					
					<p>2. PRIVACY POLICY</p>
					<p>By using the Website, You consent to the collection and use of certain information about You, as specified in the Privacy Policy. PPV Spy encourages users of the Website to frequently check PPV Spy&rsquo;s Privacy Policy for changes.</p>
					
					<p>3. CHANGES TO AGREEMENT AND PRIVACY POLICY</p>
					<p>PPV SPY RESERVES THE RIGHT TO CHANGE THIS AGREEMENT AND THE PRIVACY POLICY AT ANY TIME UPON NOTICE TO YOU, TO BE GIVEN BY THE POSTING OF A NEW VERSION OR A CHANGE NOTICE ON THE WEBSITE. IT IS YOUR RESPONSIBILITY TO REVIEW THIS AGREEMENT AND THE PRIVACY POLICY PERIODICALLY. IF AT ANY TIME YOU FIND EITHER UNACCEPTABLE, YOU MUST IMMEDIATELY LEAVE THE WEBSITE AND CEASE USING THE SERVICES. Unless PPV Spy obtains Your express consent, any revised Privacy Policy will apply only to information collected by PPV Spy after such time as the revised Privacy Policy takes effect, and not to information collected under any earlier Privacy Policies.</p>
					...
					<p>PPV Spy imposes certain restrictions on Your use of the Website and the Services. You represent and warrant that you will not: (a) violate or attempt to violate any security features of the Website or Services; (b) copy or otherwise duplicate, directly or indirectly, any portion of the Website, including without limitation, all designs, information, photographs, images, drawings, videos, music, text, typefaces, graphics, products, code, and other files, and the selection, arrangement and organization thereof (collectively, &quot;PPV Spy Content&quot;); (c) use any software that enables copying or duplication of PPV Spy Content for later off-line viewing; (d) distribute, display, modify, transmit, resell, reuse, or repost PPV Spy Content in any electronic form, including any online service, the Internet or any other telecommunications medium which now exists or shall exist in the future, for any purpose, without the prior written permission of PPV Spy; (e) access content or data not intended for You, or log onto a server or account that You are not authorized to access; (f) attempt to probe, scan, or test the vulnerability of the Services, the Website, or any associated system or network, or breach security or authentication measures without proper authorization; (g) interfere or attempt to interfere with the use of the Website or Services by any other user, host or network, including, without limitation by means of submitting a virus, overloading, &quot;flooding,&quot; &quot;spamming,&quot; &quot;mail bombing,&quot; or &quot;crashing&quot;; (h) use the Website or Services to send unsolicited e-mail, including without limitation promotions or advertisements for products or services; (i) forge any TCP/IP packet header or any part of the header information in any e-mail or in any uploading or posting to, or transmission, display, performance or distribution by means of, the Website or Services; or (j) attempt to modify, reverse-engineer, decompile, disassemble or otherwise reduce or attempt to reduce to a human-perceivable form any of the source code used by PPV Spy in providing the Website or Services. Any violation of this section may subject You to civil and/or criminal liability.</p>
					
					<p>9. INTELLECTUAL PROPERTY</p>
					<p>The Website and all proprietary content and materials located on the Website, including without limitation any logos, designs, text, graphics and other files, and the selection, arrangement and organization thereof, are the intellectual property of PPV Spy. Except as explicitly provided, neither Your use of the Website and Services, nor your entry into this Agreement, grant You any right, title or interest in or to any such content or materials. PPV SPY (the &quot;PPV Spy Marks&quot;) are trademarks or registered trademarks of PPV Spy The Website is Copyright © 2010 to the present, PPV Spy Entertainment, LLC. ALL RIGHTS ARE RESERVED.</p>
					
					<p>10. DISCLAIMERS; LIMITATION OF LIABILITY</p>
					<p>(a) NO WARRANTIES.  </p>
					<p>PPV SPY HEREBY DISCLAIMS ALL WARRANTIES. THE WEBSITE AND SERVICES ARE PROVIDED &quot;AS IS&quot; AND &quot;AS AVAILABLE.&quot; TO THE MAXIMUM EXTENT PERMITTED BY LAW, PPV SPY EXPRESSLY DISCLAIMS ANY AND ALL WARRANTIES, EXPRESS OR IMPLIED, REGARDING THE WEBSITE, INCLUDING, BUT NOT LIMITED TO, ANY IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NONINFRINGEMENT.  PPV SPY DOES NOT WARRANT THAT THE WEBSITE OR THE SERVICES WILL MEET YOUR REQUIREMENTS, THAT THE OPERATION OF THE WEBSITE OR THE SERVICES WILL BE UNINTERRUPTED OR ERROR-FREE.</p>
					
					<p>(b) YOUR RESPONSIBILITY FOR LOSS OR DAMAGE</p>
					<p>YOU AGREE THAT YOUR USE OF THE WEBSITE AND SERVICES IS AT YOUR SOLE RISK. YOU WILL NOT HOLD PPV SPY RESPONSIBLE FOR ANY LOSS OR DAMAGE THAT RESULTS FROM YOUR ACCESS TO OR USE OF THE WEBSITE, INCLUDING WITHOUT LIMITATION ANY LOSS OR DAMAGE TO ANY OF YOUR COMPUTERS OR DATA. THE INFORMATION AND SERVICES MAY CONTAIN BUGS, ERRORS, PROBLEMS OR OTHER LIMITATIONS. </p> 
					
					<p>(c) LIMITATION OF LIABILITY</p>
					<p>THE LIABILITY OF PPV SPY IS LIMITED. TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL PPV SPY BE LIABLE FOR SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES, LOST PROFITS, LOST DATA OR CONFIDENTIAL OR OTHER INFORMATION, LOSS OF PRIVACY, COSTS OF PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES, FAILURE TO MEET ANY DUTY INCLUDING WITHOUT LIMITATION OF GOOD FAITH OR OF REASONABLE CARE, NEGLIGENCE, OR OTHERWISE, REGARDLESS OF THE FORESEEABILITY OF THOSE DAMAGES OR OF ANY ADVICE OR NOTICE GIVEN TO PPV SPY ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF THE WEBSITE OR SERVICES. THIS LIMITATION SHALL APPLY REGARDLESS OF WHETHER THE DAMAGES ARISE OUT OF BREACH OF CONTRACT, TORT, OR ANY OTHER LEGAL THEORY OR FORM OF ACTION. ADDITIONALLY, THE MAXIMUM LIABILITY OF PPV SPY TO YOU UNDER ALL CIRCUMSTANCES WILL BE EQUAL TO THE AGGREGATE PRICE YOU PAID TO PPV SPY DURING THE TWELVE MONTHS PRECEDING THE INCIDENT OR INCIDENTS GIVING RISE TO SUCH LIABILITY. YOU AGREE THAT THIS LIMITATION OF LIABILITY REPRESENTS A REASONABLE ALLOCATION OF RISK AND IS A FUNDAMENTAL ELEMENT OF THE BASIS OF THE BARGAIN BETWEEN PPV SPY AND YOU. THE WEBSITE AND SERVICES WOULD NOT BE PROVIDED WITHOUT SUCH LIMITATIONS.</p>
					
					<p>(d) APPLICATION</p>
					<p>THE ABOVE DISCLAIMERS, WAIVERS AND LIMITATIONS DO NOT IN ANY WAY LIMIT ANY OTHER DISCLAIMER OF WARRANTIES OR ANY OTHER LIMITATION OF LIABILITY IN ANY OTHER AGREEMENT BETWEEN YOU AND PPV SPY. SOME JURISDICTIONS MAY NOT ALLOW THE EXCLUSION OF CERTAIN IMPLIED WARRANTIES OR THE LIMITATION OF CERTAIN DAMAGES, SO SOME OF THE ABOVE DISCLAIMERS, WAIVERS AND LIMITATIONS OF LIABILITY MAY NOT APPLY TO YOU. UNLESS LIMITED OR MODIFIED BY APPLICABLE LAW, THE FOREGOING DISCLAIMERS, WAIVERS AND LIMITATIONS SHALL APPLY TO THE MAXIMUM EXTENT PERMITTED, EVEN IF ANY REMEDY FAILS ITS ESSENTIAL PURPOSE. NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU THROUGH THE WEBSITE OR OTHERWISE SHALL ALTER ANY OF THE DISCLAIMERS OR LIMITATIONS STATED IN THIS SECTION.</p>
					
					<p>11. YOUR REPRESENTATIONS AND WARRANTIES</p>
					<p>You represent and warrant that Your use of the Website and Services will be in accordance with this Agreement and any other PPV Spy policies, and with any applicable laws or regulations.</p>
					
					<p>12. INDEMNITY BY YOU</p>
					<p>Without limiting any indemnification provision of this Agreement, You agree to defend, indemnify and hold harmless PPV Spy and its officers, directors, employees, agents, affiliates, representatives, sublicensees, successors, assigns, and Industry Professionals (collectively, the &quot;Indemnified Parties&quot;) from and against any and all claims, actions, demands, causes of action and other proceedings (collectively, &quot;Claims&quot;), including but not limited to legal costs and fees, arising out of or relating to: (i) Your breach of this Agreement, including without limitation any representation or warranty contained in this Agreement; (ii) Your access to or use of the Website or Services; (iii) Your provision to PPV Spy or any of the Indemnified Parties of information or other data; or (iv) Your violation or alleged violation of any foreign or domestic, federal, state or local law or regulation.</p>
					...
					<p>14. TERMINATION</p>
					<p>Either party may terminate this Agreement and its rights hereunder at any time, for any or no reason at all, by providing to the other party notice of its intention to do so. This Agreement shall automatically terminate in the event that You breach any of this Agreement&rsquo;s representations, warranties or covenants. Such termination shall be automatic, and shall not require any action by PPV Spy. Upon termination, all rights and obligations created by this Agreement will terminate, except that Sections 1, 4, 5, 7, 8, 9, 10, 11, 12, 13, 14, 15 and 16 will survive any termination of this Agreement. For clarification, termination of this Agreement will not relieve You of Your obligation to pay any fees owed PPV Spy. If PPV Spy, in PPV Spy&rsquo;s discretion, takes legal action against You in connection with any actual or suspected breach of this Agreement, PPV Spy will be entitled to recover from You as part of such legal action, and You agree to pay, PPV Spy&rsquo;s reasonable costs and attorneys&rsquo; fees incurred as a result of such legal action. The PPV Spy Parties will have no legal obligation or other liability to You or to any third party arising out of or relating to any termination of this Agreement.</p>
					
					<p>15. NOTICES</p>
					<p>All notices required or permitted to be given under this Agreement must be in writing. PPV Spy shall give any notice by email sent to the most recent email address, if any, provided by You to PPV Spy. You agree that any notice received from PPV Spy electronically satisfies any legal requirement that such notice be in writing. YOU BEAR THE SOLE RESPONSIBILITY OF ENSURING THAT YOUR EMAIL ADDRESS ON FILE WITH PPV SPY IS ACCURATE AND CURRENT, AND NOTICE TO YOU SHALL BE DEEMED EFFECTIVE UPON THE SENDING BY PPV SPY OF AN EMAIL TO THAT ADDRESS. You shall give any notice to PPV Spy by means of: (1) mail, postage prepaid, to 11622 El Camino Real Suite 100 San Diego, CA 92130; or (2) email to Ryan@bevomedia.com. Notice to BeVo Media will be deemed effective upon receipt by BeVo Media thereof.</p>
					
					<p>16. GENERAL</p>
					<p>This Agreement constitutes the entire agreement between PPV Spy and You concerning Your use of the Website and Services. This Agreement may only be modified by a written amendment signed by an authorized executive of PPV Spy or by the unilateral amendment of this Agreement by PPV Spy and by the posting by PPV Spy of such amended version. If any part of this Agreement is held invalid or unenforceable, that part will be construed to reflect the parties&rsquo; original intent, and the remaining portions will remain in full force and effect. A waiver by either party of any term or condition of this Agreement or any breach thereof, in any one instance, will not waive such term or condition or any subsequent breach thereof. This Agreement and all of Your rights and obligations hereunder will not be assignable or transferable by You without the prior written consent of PPV Spy. PPV Spy may, in its sole discretion, assign or otherwise transfer all or any part of its rights and obligations under this Agreement without Your consent or notice to You. This Agreement will be binding upon and will inure to the benefit of the parties, their successors and permitted assigns. You and PPV Spy are independent contractors, and no agency, partnership, joint venture or employee-employer relationship is intended or created by this Agreement. You acknowledge and agree that any actual or threatened breach of this Agreement or infringement of proprietary or other third party rights by You would cause irreparable injury to PPV Spy and PPV Spy&rsquo;s licensors and suppliers, and would therefore entitle PPV Spy or PPV Spy&rsquo;s licensors or suppliers, as the case may be, to injunctive relief. The headings in this Agreement are for the purpose of convenience only and shall not limit, enlarge, or affect any of the covenants, terms, conditions or provisions of this Agreement.</p>
