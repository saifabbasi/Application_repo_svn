...
//		  $e = date('Y-m-d', strtotime($_POST['edate']));
	...
	Public Function LightboxTemplate_Final()
	{
		...
		$this->Presets = array(
			...
			'AFFSTEP9'=>array('TITLE'=>'Tutorial Complete!', 'DONE'=>TRUE, 'LINK'=>'#', 'CONTENT'=>'That\'s it! Feel free to click around and contact your assigned mentor if you have any questions.<br/><br/>Are you a big publisher and want to host all of this on your own server? Check out the Self Hosted Version <a href="/BevoMedia/User/SelfHostedLogin.html">Here</a>.'),
