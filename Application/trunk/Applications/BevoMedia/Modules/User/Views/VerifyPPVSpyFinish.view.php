...
Click <a href="#" onclick="parent.location = '/BevoMedia/PPVSpy/Index.html'; ">here</a> to start using the PPVSpy tool.

<br /><br />

To access the Bevo PPVSpy in the future, go back to the Apps section and select Launch App.
