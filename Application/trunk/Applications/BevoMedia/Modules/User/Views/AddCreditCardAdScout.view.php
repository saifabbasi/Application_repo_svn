...
?>
	...
	<form class="appform registerForm" method="post" action="/BevoMedia/User/AddCreditCardProcess.html" id="AddCCProcess">
			<input type="hidden" name="adscout" value="1" />
		<!--<table>-->
...
?>
			...
			<label>
				<span class="label">AdScout Plan:*</span>
			</label>
				<input type="radio" name="adscoutPlan" value="1" class="required formtxt adscout-plan" style="width: 30px; margin-left: -7px;" /> Monthly ($150 /month)<br />
				<input type="radio" name="adscoutPlan" value="2" class="required formtxt adscout-plan" style="width: 30px; margin-left: 208px;" checked /> One-Time ($399 one-time)<br />
				<div class="clear"></div>
			
				<div id="adscoutMonthlyNotice" style="color: #f00; text-align: center; display: none;"><br />You can cancel or upgrade your subscription anytime by going to the My Products section<br /> in your Account Information Section</div>
			<br />
...
<script type="text/javascript">
	...
	$('.adscout-plan').change(function() {

		if ($('.adscout-plan:checked').val()==1)
		{
			$('#adscoutMonthlyNotice').show();
		} else 
		{
			$('#adscoutMonthlyNotice').hide();
		}
