...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			colors: ['#203070','#3060A0','#1030ff','#be1e2d','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744'],
			//colors: ['#203070','#3060A0','#1030ff','#0000dd','#1050ff','#002060','#a0b0f0','#8888ff','#80a0b0','#002040'],
			textColors: [], //corresponds with colors array. null/undefined items will fall back to CSS
			parseDirection: 'x', //which direction to parse the table data
			pieMargin: 20, //pie charts only - spacing around pie
			pieLabelPos: 'inside',
			lineWeight: 3, //for line and area - stroke weight
			barGroupMargin: 10,
		...
		function scrapeTable(){
			...
			var tableData = {
				...
				yLabels: function(){
					...
					var numLabels = Math.round(chartHeight / o.labelsHeight);
		...
		var createChart = {
			...
			line: function(area){
				...
				if(yLabels.length == 1)
				{
					$('#JQueryChartDisplay')[0].style.paddingLeft = '0px';
				}
			},
		...
		if (o.transparent) {
			canvasContain.css('background', 'none');
		}
		
		if (o.borderWidth>0) {
			canvasContain.css('border-width', o.borderWidth);
		} else
		if (o.borderWidth==0) {
			canvasContain.css('border-width', o.borderWidth);
			canvasContain.css('border-left-width', 1);
			canvasContain.css('border-bottom-width', 1);
		}
