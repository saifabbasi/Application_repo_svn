...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			{text: 'Today', dateStart: modToday, dateEnd: modToday },
			{text: 'Yesterday', dateStart: modYesterday, dateEnd: modYesterday },
			{text: 'Last 7 days', dateStart: modToday + '-7days', dateEnd: modToday },
			{text: 'Month to date', dateStart: function(){ return Date.parse(modToday).moveToFirstDayOfMonth();  }, dateEnd: modToday },
			{text: 'Year to date', dateStart: function(){ var x= Date.parse(modToday); x.setMonth(0); x.setDate(1); return x; }, dateEnd: modToday },
			//extras:
...
return-1;};Date.isLeapYear=function(year){return(((year%4===0)&&(year%100!==0))||(year%400===0));};Date.getDaysInMonth=function(year,month){return[31,(Date.isLeapYear(year)?29:28),31,30,31,30,31,31,30,31,30,31][month];};Date.getTimezoneOffset=function(s,dst){return '-0500'; return(dst||false)?Date.CultureInfo.abbreviatedTimeZoneDST[s.toUpperCase()]:Date.CultureInfo.abbreviatedTimeZoneStandard[s.toUpperCase()];};Date.getTimezoneAbbreviation=function(offset,dst){var n=(dst||false)?Date.CultureInfo.abbreviatedTimeZoneDST:Date.CultureInfo.abbreviatedTimeZoneStandard,p;for(p in n){if(n[p]===offset){return p;}}
